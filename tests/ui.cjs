...
(async()=>{
 ...
 try{
  ...
  await page.locator('#applyHandoff').click();assert.equal(await page.locator('[data-select-day="mon"] small').textContent(),'5 exercises · 60m');assert.equal(await page.locator('[data-select-day="wed"] small').textContent(),'5 exercises · 60m');assert.equal(await page.locator('[data-select-day="fri"] small').textContent(),'5 exercises · 60m');
